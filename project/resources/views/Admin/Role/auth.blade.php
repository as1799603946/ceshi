      ...
      <div class="mws-form-inline"> 
       <div class="mws-form-row"> 
        ...
        <div class="mws-form-item clearfix"> 
         <h4>当前角色:{{$role->rname}}的权限信息</h4> 
         <ul class="mws-form-list inline">
            @foreach($node as $row)
            <li><input type="checkbox" name="nids[]" value="{{$row->id}}" @if(in_array($row->id,$nids)) checked @endif ><label>{{$row->desc}}</label></li> 
            @endforeach
