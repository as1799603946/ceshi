...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head> 
  ...
  <link href="/static/xiangmv/css/jsstyle.css" rel="stylesheet" type="text/css" /> 
  <script type="text/javascript" src="/static/xiangmv/js/address.js"></script> 
 </head> 
 <body> 
  <!--顶部导航条 --> 
  ...
  <div class="nav white"> 
   <div class="logo">
    <img src="/static/xiangmv/images/logo.png" />
   </div> 
   <div class="logoBig"> 
  ...
  <div class="concent"> 
   ...
   <div class="paycont"> 
     ...
     <ul> 
      ...
      <li class="user-addresslist" uid="{{$rows->id}}"> 
       <div class="address-left"> 
        <div class="user"> 
         <span class="buy-address-detail"> <span class="buy-user">名字:{{$rows->name}} </span> <span class="buy-phone">电话:{{$rows->phone}}</span> </span> 
        </div> 
        <div class="default-address"> 
         <span class="buy-line-title buy-line-title-type">收货地址：</span> 
         <span class="buy--address-detail"> <span class="province">{{$rows->xhuo}}</span>  
        </div> 
       <!--  <ins class="deftip">
         默认地址 
         </ins>  -->
    ...
    <div class="logistics"> 
     <h3>选择支付方式</h3> 
     <ul class="pay-list"> 
      <li class="pay card"><img src="/static/xiangmv/images/wangyin.jpg" />银联<span></span></li> 
      <li class="pay qq"><img src="/static/xiangmv/images/weizhifu.jpg" />微信<span></span></li> 
      <li class="pay taobao"><img src="/static/xiangmv/images/zhifubao.jpg" />支付宝<span></span></li> 
     </ul> 
    </div> 
    <div class="clear"></div> 
    <!--订单 --> 
          ...
          <li class="td td-item"> 
           ...
           <div class="item-info"> 
            <div class="item-basic-info"> 
             <a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">{{$row['sname']}}</a> 
            </div> 
           </div> </li> 
          <li class="td td-info"> 
       ...
       <!-- 选择地址开始 -->
        <div class="box"> 
         ...
         <div id="holyshit268" class="pay-address"> 
          <p class="buy-footer-address"> 寄送至：<span class="buy-line-title buy-line-title-type" id="address">{{$addressfirst->xhuo}}</span>  </p> 
