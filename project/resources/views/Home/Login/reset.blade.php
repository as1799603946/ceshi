...
<html>
 <head> 
  <meta charset="UTF-8" /> 
  <title>账户中心</title> 
  <link rel="stylesheet" href="/static/password/mima/Css/ucenter.css" /> 
  <link href="/static/password/xiangmu/AmazeUI-2.4.2/assets/css/admin.css" rel="stylesheet" type="text/css" /> 
  <link href="/static/password/xiangmu/AmazeUI-2.4.2/assets/css/amazeui.css" rel="stylesheet" type="text/css" /> 
  <link href="/static/password/xiangmu/css/personal.css" rel="stylesheet" type="text/css" /> 
  <link href="/static/password/xiangmu/css/stepstyle.css" rel="stylesheet" type="text/css" /> 
  <script src="/static/password/xiangmu/AmazeUI-2.4.2/assets/js/jquery.min.js" type="text/javascript"></script> 
  <script src="/static/password/xiangmu/AmazeUI-2.4.2/assets/js/amazeui.js" type="text/javascript"></script> 
 </head> 
 <body> 
  <div id="header"> 
   <div class="header-layout"> 
    <div style="float:left;margin-top:-15px;"> 
     <img src="/static/password/xiangmv/images/timg1.jpg" alt="" style="height:70px" /> 
    </div> 
      ...
      <div class="center div2" style="display:block;"> 
       <div class="am-form-group"> 
        ...
        <div class="am-form-content"> 
         <input type="password" name="upass" id="user-new-password" placeholder="由数字、字母、下划线组合的6-15位密码" /> 
         <span></span> 
        </div> 
       </div> 
       <label for="user-new-password" class="am-form-label">确认密码</label> 
       <div class="am-form-content"> 
        <input type="password" name="repass" id="user-new-password" placeholder="两次密码一致" /> 
        <span></span> 
       </div> 
      </div> 
    </div> 
