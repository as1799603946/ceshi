								...
								<div class="category-content" id="guide_2">
									...
									<div class="category">
										<ul class="category-list" id="js_climit_li">
											...
											@foreach($common_cates_data as $row)
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><i><img src="/h/images/cake.png"></i><a class="ml-22" title="点心">{{ $row->cname }}</a></h3>
													<em>&gt;</em></div>
													...
													<div class="area-in">
														<div class="area-bg">
															<div class="menu-srot">
																<div class="sort-side">
																	<dl class="dl-sort">
																		@foreach($row->sub as $kk=>$vv)
																		<dt><span title="">{{ $vv->cname }}</span></dt>							@foreach($vv->sub as $KKK=>$vvv)		
																		<dd><a title="" href="#"><span>{{ $vvv->cname }}</span></a></dd>
																		    @endforeach
																		@endforeach
																	</dl>
