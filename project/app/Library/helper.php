...
function sendsphone($phone)
{
    ...
    $options['accountsid']='ee111ae2d122b91c1a2e7dd4074c56b5';
    //填写在开发者控制台首页上的Auth Token
    $options['token']='35b69e52342bb01ccd532440c33f8089';

    //初始化 $options必填
    $ucpass = new Ucpaas($options);

    $appid = "6eb9d1271c8c42a1925fdc354be852ae";	//应用的ID，可在开发者控制台内的短信产品下查看
    $templateid = "496952";    //可在后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
    $param = rand(1000,9999); //多个参数使用英文逗号隔开（如：param=“a,b,c”），如为参数则留空

    //将发送的校验码存储在cookie中
    \Cookie::queue('fcode',$param,1);//cookie名 fcode cookie值 $param 时间 一分钟
    $mobile = $phone;//手机号
